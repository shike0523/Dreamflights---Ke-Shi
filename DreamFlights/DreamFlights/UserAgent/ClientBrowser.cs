...
namespace DreamFlights.UserAgent
{
    public class ClientBrowser
    {
        ...
        private static void NameVersionAction(Match match, Object obj)
        {
            ...
            current.IsMobileDevice = new Regex(@"^[a-zA-Z]+", RegexOptions.IgnoreCase).Match(match.Value).Value;
            if (match.Value.Length > current.IsMobileDevice.Length)
            {
                current.Version = match.Value.Substring(current.IsMobileDevice.Length + 1);
            }
        }
        ...
        private static List<MatchExpression> _matchs = new List<MatchExpression> {
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Opera Mini";
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = nameAndVersion[0].Replace('_',' ');
                    current.Version = nameAndVersion[1];
                }
            },
            new MatchExpression{
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "MIUI Browser";
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = new Regex("(.+)").Replace(nameAndVersion[0],"$1 WebView");
                    current.Version = nameAndVersion[1];
                }
            },
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Android Browser";
                    current.Version = nameAndVersion[0];
                }
            },
            new MatchExpression{
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Dolphin";
                    current.Version = nameAndVersion[1];
                }
            },
            new MatchExpression{
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Facebook";
                    current.Version = nameAndVersion[0];
                }
            },
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Firefox";
                    current.Version = nameAndVersion[0];
                }
            },
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Mobile Safari";
                    current.Version = nameAndVersion[1];
                }
            },
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = nameAndVersion[1];
                    current.Version = nameAndVersion[0];
                }
            },
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = nameAndVersion[0];
            ...
            new MatchExpression{
                ...
                Action = (Match match,Object obj) =>{
                    ...
                    current.IsMobileDevice = "Netscape";
                    current.Version = nameAndVersion[1];
                }
            },
            new MatchExpression{
