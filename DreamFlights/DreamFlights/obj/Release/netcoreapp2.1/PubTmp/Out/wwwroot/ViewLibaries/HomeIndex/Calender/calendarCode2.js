...
function Calendar() {
    ...
    if (document.getElementById("tip-panel").innerHTML == TranslateLanguage("Please select a return date", "请选择一个返回日期") && clickCount == 0) {
        document.getElementById("tip-panel").innerHTML = TranslateLanguage("Confirm?", "确定吗？");
    } else if (clickCount == 0) {
        document.getElementById("tip-panel").innerHTML = TranslateLanguage("Please select a depart date", "请选择一个出发日期");
    } else if (clickCount == 1) {
        document.getElementById("tip-panel").innerHTML = TranslateLanguage("Please select a return date", "请选择一个返回日期");
    }
